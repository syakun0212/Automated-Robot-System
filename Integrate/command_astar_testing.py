...
def main():
    ...
    cmdSet = [ # Type, data
        ...
        # Forward Elipse Loop
('arc', -0.7853981633974483, -0.4, 0.2), ('line', 0.1414213562373095, 0.2), ('arc', -0.7853981633974483, 0.4, 0.2), ('arc', 1.5707963267948966, 0.4, 0.2), ('arc', -1.5707963267948966, -0.4, 0.2)
