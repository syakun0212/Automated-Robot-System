...
class ParticleFilterNode(object):
    ...
    def __init__(self, N, camMatrix):
        ...
        self.obstaclesInput = [
            ObstacleData((0.73, 0.94, math.pi/2), obstacleSize, (-1, 0, 0, 0)),
            ObstacleData((1.25, 0.59, 0), obstacleSize, (-1, 0, 0, 0)),
            ObstacleData((0.43, 1.56, math.pi/2), obstacleSize, (-1, 0, 0, 0)),
        ]
